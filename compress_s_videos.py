#!/usr/bin/env python3
"""
Script to batch compress S01 videos to half resolution (320x180) using NVIDIA NVENC.
Original videos remain untouched and safe in their original directory.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Batch compress S01 videos to 320x180")
    parser.add_argument(
        "--input-dir",
        type=Path,
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path(r"E:\Projects\Vecna\workspace\data\compressed_videos"),
        help="Thu muc chua video nen dau ra",
    )
    parser.add_argument(
        "--pattern",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="320:180",
        help="Do phan giai dau ra (mac dinh: 320:180)",
    )
    parser.add_argument(
        "--cq",
        type=int,
    ...
    print(f"📂 Thu muc video nen:    {output_dir}")
    print("=" * 70)
