...
class TextEmbedding(FeatureExtractor):
    ...
    def require_input() -> Any:
        # Analysis is driven by keyframe identity; the actual text is loaded
        # from the configured sibling feature (OCR or ASR) for that frame.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Generic analyser/searcher constructor fields not used by HF AutoModel.
        ...
        # FP16 is useful on CUDA, but CPU fallback should stay FP32 for broad
        # operator support and predictable kernels.
    ...
    def _encode_texts(self, texts: list[str]) -> np.ndarray:
        ...
        with torch.inference_mode():
            ...
            # BGE-M3 dense retrieval uses the normalized CLS representation.
