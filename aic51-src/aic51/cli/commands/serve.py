...
class ServeCommand(BaseCommand):
    ...
    def _start_frontend(self, dev_mode: bool):
        ...
        if dev_mode:
            ...
            frontend_process = subprocess.Popen(dev_cmd, env=dev_env, cwd=str(self._frontend_dir), shell=True)
        else:
    ...
    def _build_frontend(self):
        ...
        target_dir = web_dir / "dist"
        if target_dir.exists():
            shutil.rmtree(target_dir)

        shutil.move(str(built_dir), str(target_dir))
