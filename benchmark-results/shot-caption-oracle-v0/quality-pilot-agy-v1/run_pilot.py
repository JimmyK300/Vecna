...
SANDBOXES = Path('C:/Users/minhc/.codex/media-sandboxes/issue95-quality-v1')
...
def main():
    ...
    for q in IDS:
        ...
        for family in FAMILIES:
            ...
            prompt = PREFIX + (BASE/'prompts'/f'{family}.txt').read_text(encoding='utf-8')
            ...
            row['candidate_valid'] = rc == 0 and result.get('status') == 'SUCCESS' and bool(caption.strip()) and viewed and not unexpected
