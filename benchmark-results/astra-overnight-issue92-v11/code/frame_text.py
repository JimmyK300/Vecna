...
def main():
    ...
    for q in queries:
        ...
        rankings.append({'query_id':qid,'arms':{'control':best[qid]['arms']['protected_full100_rrf60'],'asr_only':rerank_frames(control,dict(zip(chosen,result['logits'])))}})
        timings.append(result)
    summary=evaluate(rankings,out,'asr_only')
