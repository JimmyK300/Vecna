...
if __name__ == "__main__":
    ...
    json_file = 'vintern_results.json'

    # Attempt to parse the response string as JSON
    try:
        # The response can sometimes be wrapped in markdown ```json ... ```
    ...
    # Create the entry, merging image info with the response object
    ...
    # append entry into a JSON array file
    if os.path.exists(json_file):
        try:
            ...
            if isinstance(data, list):
                ...
                # if the file holds a single object, convert to list
                data = [data, entry]
        except Exception:
    ...
    print(f'Wrote OCR result to {json_file}')